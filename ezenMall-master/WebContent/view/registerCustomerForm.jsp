...
<head>
	...
	<script type="text/javascript">		// Input 항목 유효성 검사
		function isValidForm() {
			...
			var rgx_email = /^[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*.[a-zA-Z]{2,3}$/i; 	// 이메일 정규 표현식
return true;
			...
			if (rgx_email.test(email.value) != true) {
				alert('[Email 입력 오류] 유효한 Email 주소를 입력해 주십시오.');
				email.focus();
				return false;
			}
			return true;
		...
		<div class="row" style="margin-top: 90px">
			...
			<div class="col-md-10">
				...
				<form action="/FulfillmentService/control/loginRegisterServlet?action=register" class="form-horizontal" 
					...
					<div class="form-group">
						<label class="col-md-4 control-label">핸드폰번호</label>
						<div class="col-md-3">
							<input type="text" class="form-control" name="cTel" id="tel">
						</div>
					</div>
					<div class="form-group">
